...
@SpringBootTest
public class RegistrationControllerTest9 {
    @Autowired
    ...
    private void setUp() throws OverLimitGroupException, AssignmentException,
        ...
        subjectGroup.setNumberOfTeacher(1);
        subjectGroup.setCode("N5");
        Mockito.doThrow(AssignmentException.class)
    ...
    public void testFindAllEnableTermSubject(){
        ...
        try {
            mockMvc.perform(requestBuilder)
                    ...
                    .andExpect(jsonPath("$"
                            ,containsString("Không được phép đăng kí môn học này!")));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
