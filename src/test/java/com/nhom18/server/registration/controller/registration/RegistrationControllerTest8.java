...
@SpringBootTest
public class RegistrationControllerTest8 {
    @Autowired
    ...
    private void setUp() throws OverLimitGroupException, AssignmentException,
        ...
        Mockito.doThrow(new OverLimitGroupException(subjectGroup))
    ...
    public void testFindAllEnableTermSubject(){
        ...
        try {
            mockMvc.perform(requestBuilder)
                    ...
                    .andExpect(jsonPath("$"
                            ,containsString("Nhóm N5 chỉ được tối đa 1 giảng viên đăng kí!")));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
