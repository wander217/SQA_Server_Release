...
import com.nhom18.server.entity.group.Subject;
...
@SpringBootTest
public class RegistrationControllerTest7 {
    @Autowired
    ...
    private void setUp() throws OverLimitGroupException, AssignmentException,
        ...
        subjectGroup.setCode("N2");
        Subject subject = new Subject();
        subject.setName("ABC");
        TermSubject termSubject = new TermSubject();
        termSubject.setSubject(subject);
        subjectGroup.setTermSubject(termSubject);
        Mockito.doThrow(new DuplicatedTimetableException(subjectGroup))
    ...
    public void testFindAllEnableTermSubject(){
        ...
        try {
            mockMvc.perform(requestBuilder)
                    ...
                    .andExpect(jsonPath("$"
                            ,containsString("Nhóm đăng kí bị trùng lịch với nhóm N2 của môn ABC")));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
